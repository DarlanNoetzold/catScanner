...
tool_status_and_timing = [
    ...
    # 75
    ["Microsoft SQL Server Error Log", 0, proc_low, " < 30s", "elmahxd",
     ["unable to resolve host address", "Connection timed out"]],
    ...
    # 81
    ["No names were discovered", 1, proc_med, " < 15m", "amass",
...
if args_on_cmd.help or (not args_on_cmd.update \
    ...
    while (rs_avail_tools < len(tools)):
        ...
        print(output_bcolors.BG_ENDL_TXT + "[ Report Generation Phase Completed. ]" + output_bcolors.ENDC)

        os.system('setterm -cursor on')
        os.system('rm /tmp/rapidscan_te* > /dev/null 2>&1')